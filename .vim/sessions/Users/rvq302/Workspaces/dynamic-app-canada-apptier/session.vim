...
nnoremap <silent> \cx :CocList extensions
nnoremap <silent> \cR :CocRestart
nnoremap <silent> \cc :CocList commands
nnoremap <silent> \cl :CocList locationlist
...
noremap \p "*p
noremap \y "*y
nnoremap \t :terminal:exe "resize " . (winheight(0) * 1/3)
nmap <silent> gr <Plug>(coc-references)
nmap <silent> gvi :vsplit<Plug>(coc-implementation)
nmap <silent> gi <Plug>(coc-implementation)
nmap <silent> gvd :vsplit<Plug>(coc-definition)
...
set pastetoggle=<F2>
set ruler
set runtimepath=~/.vim,~/.fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-polyglot,~/.vim/plugged/ale,~/.vim/plugged/comfortable-motion.vim,~/.vim/plugged/lightline.vim,~/.vim/plugged/coc.nvim,~/.vim/plugged/git-blame.vim,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-markdown,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim81,/usr/local/share/vim/vimfiles/after,~/.vim/plugged/vim-polyglot/after,~/.vim/after
set noshowmode
set softtabstop=4
set splitbelow
set splitright
...
silent only
silent tabonly
cd ~/Workspaces/dynamic-app-canada-apptier
...
argglobal
%argdel
edit dynamic-app-canada-apptier-web/src/main/java/com/capitalone/canadadynamicapps/apptier/rest/resources/AppResource.java
...
silent! normal! zE
let s:l = 319 - ((24 * winheight(0) + 24) / 49)
...
normal! 079|
tabnext 1
badd +0 dynamic-app-canada-apptier-web/src/main/java/com/capitalone/canadadynamicapps/apptier/rest/resources/AppResource.java
